...
Copyright (C) 2014-2016 Iulia Cazan
...
class SIRSC_Image_Regenerate_Select_Crop
{
	...
	private function init() {
		...
		if ( is_admin() ) {
			...
			$this->plugin_url = admin_url( 'options-general.php?page=image-regenerate-select-crop-settings' );
	...
	function load_assets( $hook_suffix = '' ) {
		...
		wp_enqueue_style( 'sirsc-style', plugins_url( '/assets/css/style.css', __FILE__ ), array(), '20170719', false );
		wp_register_script( 'sirsc-custom-js', plugins_url( '/assets/js/custom.js', __FILE__ ), array(), '20170719' );
	...
	function image_regenerate_select_crop_settings() {
		...
		?>
		<br/><h1><?php _e( 'Image Regenerate & Select Crop Settings', 'sirsc' ); ?></h1><br/>
		...
		<table cellspacing="0">
			<tr>
				<td class="vtopAlign">
					<h3><a class="dashicons dashicons-info" title="<?php _e( 'Details', 'sirsc' ); ?>" onclick="sirsc_toggle_info('#info_developer_mode')"></a> <?php _e( 'Images Placeholders Developer Mode', 'sirsc' ); ?> &nbsp;</h3>
				...
				<td class="vtopAlign">
					...
					<h3><label><input type="radio" name="_sirsrc_placeholders" id="_sirsrc_placeholders_none" value="" <?php checked( 1, $is_checked, true ); ?> /> <?php _e( 'no placeholder', 'sirsc' ); ?></label></h3>
				</td>
				<td class="vtopAlign">
					<?php $is_checked = ( ! empty( $settings['placeholders']['force_global'] ) ) ? 1 : 0; ?>
					<h3><label><input type="radio" name="_sirsrc_placeholders" id="_sirsrc_placeholders_force_global" value="force_global" <?php checked( 1, $is_checked, true ); ?> /> <?php _e( 'force global', 'sirsc' ); ?></label></h3>
				</td>
				<td class="vtopAlign">
					<?php $is_checked = ( ! empty( $settings['placeholders']['only_missing'] ) ) ? 1 : 0; ?>
					<h3><label><input type="radio" name="_sirsrc_placeholders" id="_sirsrc_placeholders_only_missing" value="only_missing" <?php checked( 1, $is_checked, true ); ?> /> <?php _e( 'only missing images', 'sirsc' ); ?></label></h3>
				</td>
			</tr>
		</table>
		<hr/><h2><?php _e( 'Exclude Image Sizes', 'sirsc' ); ?></h2>
		...
		if ( ! empty( $post_types ) ) {
			...
			echo '<select name="_sirsc_post_types" id="_sirsc_post_type" onchange="sirsc_load_post_type(this, \'' . esc_url( $this->plugin_url ) . '\')"><option value="">' . $has_settings . __( 'General settings (used as default for all images)', 'sirsc' ) . '</option>';
		...
		<tr>
			<td class="vtopAlign">
				<h3><a class="dashicons dashicons-info" title="<?php _e( 'Details', 'sirsc' ); ?>" onclick="sirsc_toggle_info('#info_global_ignore')"></a> <?php _e( 'Global Ignore', 'sirsc' ); ?></h3>
				<div class="sirsc_info_box_wrap">
			...
			<td class="vtopAlign">
				<h3><a class="dashicons dashicons-info" title="<?php _e( 'Details', 'sirsc' ); ?>" onclick="sirsc_toggle_info('#info_exclude')"></a> <?php _e( 'Hide Preview', 'sirsc' ); ?></h3>
				<div class="sirsc_info_box_wrap">
			...
			<td class="vtopAlign">
				<h3><a class="dashicons dashicons-info" title="<?php _e( 'Details', 'sirsc' ); ?>" onclick="sirsc_toggle_info('#info_force_original')"></a> <?php _e( 'Force Original', 'sirsc' ); ?></h3>
				<label><input type="radio" name="_sirsrc_force_original_to" id="_sirsrc_force_original_to_0" value="0" <?php checked( 1, 1, true ); ?> /> <?php _e( 'nothing selected', 'sirsc' ); ?></label>
				<div class="sirsc_info_box_wrap">
			...
			<td class="vtopAlign">
				<h3><a class="dashicons dashicons-info" title="<?php _e( 'Default Crop', 'sirsc' ); ?>" onclick="sirsc_toggle_info('#info_default_crop')"></a> <?php _e( 'Default Crop', 'sirsc' ); ?></h3>
				<div class="sirsc_info_box_wrap">
			...
			<td class="vtopAlign">
				<h3><a class="dashicons dashicons-info" title="<?php _e( 'Details', 'sirsc' ); ?>" onclick="sirsc_toggle_info('#info_clean_up')"></a> <?php _e( 'Cleanup All', 'sirsc' ); ?></h3>
				<div class="sirsc_info_box_wrap">
					<div id="info_clean_up" class="sirsc_info_box" onclick="sirsc_toggle_info('#info_clean_up')">
						...
						<hr/><?php _e( 'Please be carefull, once you click to remove the selected image size, the action is irreversible, the images generated will be deleted from your folders and database records.', 'sirsc' ); ?>
					</div>
				</div>
			</td>
			<td class="vtopAlign">
				<h3><a class="dashicons dashicons-info" title="<?php _e( 'Details', 'sirsc' ); ?>" onclick="sirsc_toggle_info('#info_regenerate')"></a> <?php _e( 'Regenerate All', 'sirsc' ); ?></h3>
				<div class="sirsc_info_box_wrap">
					<div id="info_regenerate" class="sirsc_info_box" onclick="sirsc_toggle_info('#info_regenerate')">
						...
						<hr/><?php _e( 'Please be carefull, once you click to regenerate the selected image size, the action is irreversible, the images already generated will be overwritten.', 'sirsc' ); ?>
					</div>
				</div>
			</td>
		</tr>
		...
		if ( ! empty( $all_sizes ) ) {
			foreach ( $all_sizes as $k => $v ) {
				...
				<tr class="<?php echo esc_attr( $cl ); ?>">
					<td class="vtopAlign">
						<label><input type="checkbox" name="_sirsrc_complete_global_ignore[<?php echo esc_attr( $k ); ?>]" id="_sirsrc_complete_global_ignore_<?php echo esc_attr( $k ); ?>" value="<?php echo esc_attr( $k ); ?>" <?php checked( 1, $is_checked_ignore, true ); ?> /> <?php _e( 'global ignore', 'sirsc' ); ?></label>
					</td>
					<td class="vtopAlign">
					...
					<td class="vtopAlign">
						<label><input type="checkbox" name="_sirsrc_exclude_size[<?php echo esc_attr( $k ); ?>]" id="_sirsrc_exclude_size_<?php echo esc_attr( $k ); ?>" value="<?php echo esc_attr( $k ); ?>" <?php checked( 1, $is_checked, true ); ?> /> <?php _e( 'hide', 'sirsc' ); ?></label>
					</td>
					<td class="vtopAlign">
						<label><input type="radio" name="_sirsrc_force_original_to" id="_sirsrc_force_original_to_<?php echo esc_attr( $k ); ?>" value="<?php echo esc_attr( $k ); ?>" <?php checked( 1, $is_checked_force, true ); ?> /> <?php _e( 'force original', 'sirsc' ); ?></label>
					</td>
					<td class="vtopAlign">
						<?php
						if ( ! empty( $v['crop'] ) ) {
					...
					<td class="vtopAlign">
						...
						if ( ! empty( $total_cleanup ) ) {
							?>
							<span class="button-secondary button-large" title="<?php echo intval( $total_cleanup ); ?>" onclick="sirsc_initiate_cleanup('<?php echo esc_attr( $k ); ?>');"><b class="dashicons dashicons-update" title="<?php _e( 'Cleanup All', 'sirsc' ); ?>"></b> <?php _e( 'Cleanup', 'sirsc' ); ?></span>
					...
					<td class="vtopAlign">
						...
						if ( ! $is_checked_ignore ) {
							?>
							<span class="button-primary button-large" onclick="sirsc_initiate_regenerate('<?php echo esc_attr( $k ); ?>');"><b class="dashicons dashicons-update" title="<?php _e( 'Regenerate All', 'sirsc' ); ?>"></b> <?php _e( 'Regenerate', 'sirsc' ); ?></span>
							<div class="sirsc_button-regenerate-wrap">
		...
		?>
		<tr>
			<td colspan="7"><hr /><?php submit_button(); ?></td>
		</tr>
		</table>
		</form>
		</div>
		...
		if ( ! empty( $wp_version ) && preg_match_all( '/([1-9])\.([1-9])(\.([1-9])?)?/', $wp_version, $v ) ) {
			if ( ! empty( $v ) && ! empty( $v[1][0] ) && ! empty( $v[2][0] ) ) {
				...
				if ( (int) $v[1][0] <= 4 && (int) $v[2][0] < 6 ) {
					...
					add_filter( 'admin_post_thumbnail_html', array( $this, 'append_image_generate_button_old' ), 10, 2 );
				} else {
					// Since 4.6 we have 3 parameters for admin_post_thumbnail_html hook.
					add_filter( 'admin_post_thumbnail_html', array( $this, 'append_image_generate_button' ), 10, 3 );
				}
			}
		}
	}
	...
	/**
	 * SIRSC_Image_Regenerate_Select_Crop::append_image_generate_button_old() Append or display the button for generating the missing image sizes and request individual crop of images, this is for core version < 4.6, for backward compatibility.
	 */
	function append_image_generate_button_old( $content, $post_id = 0, $thumbnail_id = 0 ) {
		$display = false;
	...
	function append_image_generate_button( $content, $post_id = 0, $thumbnail_id = 0 ) {
		...
		if ( true === $display && true === $is_the_attachment ) {
			...
			echo '<div class="sirsc_button-regenerate-wrap">' . $content_button . '</div>';
		}
	...
	function make_generate_images_button( $attachmentId = 0 ) {
		...
		<div class="sirsc_button-regenerate">
			<div id="sirsc_inline_regenerate_sizes' . intval( $attachmentId ) . '">
				<div class="button-primary button-large" onclick="sirsc_open_details(\'' . intval( $attachmentId ) . '\')"><div class="dashicons dashicons-format-gallery" title="' . esc_attr__( 'Details/Options',
				'sirsc' ) . '"></div> ' . __( 'Details/Options', 'sirsc' ) . '</div>
				<div class="button-primary button-large" onclick="sirsc_start_regenerate(\'' . intval( $attachmentId ) . '\')"><div class="dashicons dashicons-update" title="' . esc_attr__( 'Regenerate',
				'sirsc' ) . '"></div> ' . __( 'Regenerate', 'sirsc' ) . '</div>
				<div id="sirsc_recordsArray_' . intval( $attachmentId ) . '_result" class="result"><span class="spinner inline off"></span></div>
			</div>
		</div>
		<div class="sirsc_clearAll"></div>';
	...
	function make_generate_images_crop( $attachmentId = 0, $size = 'thumbnail', $click = true, $selected = 'cc' ) {
		...
		$button_regenerate = '<table cellspacing="0" cellpadding="0" title="' . esc_attr__( 'Click to generate a crop of the image from this position', 'sirsc' ) . '">';
		$c = 0;
							...
							foreach ( $all_size as $k => $v ) {
								...
								if ( ! empty( $rez_img['is_crop'] ) ) {
									if ( ! empty( $rez_img['can_be_cropped'] ) ) {
										$action .= '<div class="dashicons dashicons-image-crop"></div> ' . __( 'Crop image', 'sirsc' ) . '<div class="sirsc_clearAll"></div>' . $this->make_generate_images_crop( $postData['post_id'], $k ) . '';
									}
								}

								if ( ! empty( $rez_img['can_be_generated'] ) ) {
									$iddd = intval( $postData['post_id'] ) . $k;
									$action .= '<div class="sirsc_clearAll"></div><a class="button" onclick="sirsc_start_regenerate(\'' . $iddd . '\');"><b class="dashicons dashicons-update"></b> ' . __( 'Regenerate', 'sirsc' ) . '</a>';
								} else {
								...
								echo '<tr class="' . $cl . '" id="sirsc_recordsArray_' . intval( $postData['post_id'] ) . $k . '">
				...
				if ( ! empty( $post ) ) {
					...
					if ( $sizes != 'all' ) {
						...
						if ( ! empty( $tmp_details['crop'] ) ) {
							$crop_table = '<div class="dashicons dashicons-image-crop"></div>' . __( 'Crop image', 'sirsc' ) . '<div class="sirsc_clearAll"></div>' . preg_replace( '/[\x00-\x1F\x80-\xFF]/', '', $this->make_generate_images_crop( intval( $postData['post_id'] ), $sizes ) ) . '<div class="sirsc_clearAll"></div><a class="button" onclick="sirsc_start_regenerate(\'' . intval( $postData['post_id'] ) . $sizes . '\');"><b class="dashicons dashicons-update"></b> Regenerate</a>';
						}
						echo '<script>
						jQuery(document).ready(function () {
	...
	function calculate_total_to_cleanup( $post_type = '', $image_size_name = '', $next_post_id = 0 ) {
		...
		if ( ! empty( $image_size_name ) ) {
			...
			$tmpQuery = $wpdb->prepare( "
				...
				LEFT JOIN " . $wpdb->postmeta . " as pm ON(pm.post_id = p.ID) " . $cond_join . "
				WHERE pm.meta_key like %s AND pm.meta_value like %s AND p.ID > %d " . $cond_where,
			...
			if ( ! empty( $postData['_sisrsc_image_size_name'] ) ) {
				...
				if ( $total_to_delete > 0 ) {
					...
					$tmpQuery = $wpdb->prepare( "
						...
						LEFT JOIN " . $wpdb->postmeta . " as pm ON(pm.post_id = p.ID) " . $cond_join . "
						WHERE pm.meta_key like %s AND pm.meta_value like %s AND p.ID > %d " . $cond_where . "
						ORDER BY pm.meta_id ASC LIMIT 0, %d
						",
						'_wp_attachment_metadata',
	...
	function ajax_regenerate_image_sizes_on_request() {
		if ( ! empty( $_REQUEST['sirsc_data'] ) ) {
			...
			if ( ! empty( $postData['_sisrsc_regenerate_image_size_name'] ) ) {
				...
				$total_to_update = 0;
				$image_size_name = $postData['_sisrsc_regenerate_image_size_name'];
				$use_condition = ! empty( $postData['_sisrsc_regenerate_image_size_name_page'] ) ? true : false;
				$tmpQuery = $wpdb->prepare( "
					SELECT count( p.ID ) as total_to_update
					FROM " . $wpdb->posts . " as p " . $cond_join . "
					WHERE p.ID > %d AND p.post_mime_type like %s " . $cond_where . "
					ORDER BY p.ID ASC 
					",
					intval( $next_post_id ),
					'image/%'
					...
					if ( ! empty( $rows ) && is_array( $rows ) ) {
						foreach ( $rows as $v ) {
							...
							if ( ! empty( $filename ) && file_exists( $filename ) ) {
								$this->make_images_if_not_exists( $v['ID'], $image_size_name );
								$image = wp_get_attachment_metadata( $v['ID'] );
								$th = wp_get_attachment_image_src( $v['ID'], $image_size_name );
								if ( ! empty( $th[0] ) ) {
									$th_src = $th[0];
									echo '<span><img src="' . $th_src . '?cache=' . time() . '" /><b class="spinner inline"></b></span><hr />' . $th_src;
								} else {
	...
	function plugin_action_links( $links ) {
		...
		$all[] = '<a href="http://iuliacazan.ro/image-regenerate-select-crop">Plugin URL</a>';
