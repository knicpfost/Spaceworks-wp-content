	...
	<table class="form-table">
		...
		<tr>
			...
			<td>
				...
				Get your "Account ID" from Click & Pledge [Connect > Launcher > Settings > API Information].
			</td>
		</tr>
		...
		<tr valign='top'>
			...
			<td>
				...
				Get your "API Account GUID" from Click & Pledge [Connect > Launcher > Settings > API Information].
			</td>
		</tr>
